...
public class DeviceLocation {
    ...
    public static void getLastKnownLocation(Context context, boolean waitForGpsFix, final LocationResult cb) {
        ...
        Location last_loc;
        if (ActivityCompat.checkSelfPermission(VideonaApplication.getAppContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(VideonaApplication.getAppContext(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
