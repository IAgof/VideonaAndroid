...
import com.videona.videona.music.MusicActivity;
import com.videona.videona.share.ShareVideoActivity;
import com.videona.videona.utils.TimeUtils;
import com.videona.videona.utils.VideoUtils;
...
public class EditVideoActivity extends Activity {
        ...
        btnMusic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isMusicON) {
                    ...
                    music.setClass(EditVideoActivity.this, MusicActivity.class);
            ...
            public void onClick(View arg0) {
                ...
                final Runnable r = new Runnable() {
                        public void run() {
                            ...
                            share.setClass(EditVideoActivity.this, ShareVideoActivity.class);
                            startActivityForResult(share, VIDEO_SHARE_REQUEST_CODE);

                        }
                 };

               progressDialog = ProgressDialog.show(EditVideoActivity.this, getString(R.string.dialog_processing), getString(R.string.please_wait), true);
    ...
    private void doTrimVideo() {
        ...
        if(appPrefs.getIsMusicON()) {
            ...
            String audio_test = Environment.getExternalStorageDirectory() + "/Videona/audio_aac.aac";
...
//        int start = seekBarStart;
        int start = appPrefs.getSeekBarStart();

//        int length = seekBarEnd - start;
    ...
    protected void onPause() {
       ...
       // cutvideoPlayerState.setCurrentTime(mediaPlayer.getCurrentPosition());
    }
    ...
    public void paintSeekBar() { // Initialize seekbar
        ...
        seekBarRange.setOnRangeSeekBarChangeListener(new RangeSeekBar.OnRangeSeekBarChangeListener<Double>() {
                    ...
                    public void onRangeSeekBarValuesChanged(
                      ...
                      //  int videoProgress = mediaPlayer.getCurrentPosition();
    ...
    private void refreshDetailView() {
       ...
       // detailVideoCut.setText("[" + start + " - " + stop+"]");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==ADD_MUSIC_REQUEST_CODE ) {
            ...
            int music = data.getIntExtra("position", 0);
            ...
            musicSelected =  Environment.getExternalStorageDirectory() + File.separator + "Videona/" + mThumbPathAudioSelected[music];

            Log.d(LOG_TAG, "music selected position " + music);
    ...
    private String[] mThumbPathAudioSelected = {
            "audio_cero.aac", "audio_uno.aac",
            "audio_dos.aac", "audio_tres.aac",
            "audio_cuatro.aac", "audio_cinco.aac",
            "audio_seis.aac", "audio_siete.aac",
            "audio_ocho.aac"
    };
