package com.videona.videona.record;
...
import com.videona.videona.edit.EditVideoActivity;
...
public class RecordActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changeCamera = (ImageButton) findViewById(R.id.button_change_camera);
        // amm: Hide changeCamera
      ...
      //  Log.d(LOG_TAG, "appPrefs welcome " + showWelcome);
        ...
        changeCamera.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(LOG_TAG, "changeCamera pressed ");

                if(appPrefs.getCameraId() == 0) {
                    appPrefs.setCameraId(1);
                } else {
