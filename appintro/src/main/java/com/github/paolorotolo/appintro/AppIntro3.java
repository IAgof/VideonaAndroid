...
public abstract class AppIntro3 extends AppCompatActivity {
    ...
    final protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intro_layout3);
        ...
        /**
         *  ViewPager.setOnPageChangeListener is now deprecated. Use addOnPageChangeListener()
         *  instead of it.
         */
    ...
    public void setFadeAnimation() {
        pager.setPageTransformer(true,
                new ViewPageTransformer(ViewPageTransformer.TransformType.FADE));
    }

    public void setZoomAnimation() {
        pager.setPageTransformer(true,
                new ViewPageTransformer(ViewPageTransformer.TransformType.ZOOM));
    }
    public void setFlowAnimation() {
        pager.setPageTransformer(true,
                new ViewPageTransformer(ViewPageTransformer.TransformType.FLOW));
    }
    ...
    /**
     * Set a progress indicator instead of dots. This is recommended for a large amount of slides.
     * In this case there could not be enough space to display all dots on smaller device screens.
     */
    ...
    /**
     * Set a custom {@link IndicatorController} to use a custom indicator view for the
     * {@link AppIntro3} instead of the default one.
     *
