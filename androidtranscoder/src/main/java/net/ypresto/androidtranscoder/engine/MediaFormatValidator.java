...
class MediaFormatValidator {
    ...
    public static void validateVideoOutputFormat(MediaFormat format) {
        ...
        /*
        PrintLogs.appendLog("format: "+valueOf(format));
        PrintLogs.appendLog("spsBuffer: "+spsBuffer);
        PrintLogs.appendLog("sps: "+sps);
        PrintLogs.appendLog("profile idc baseline obtained: "+sps.profile_idc);
        PrintLogs.appendLog("profile idc baseline constant: "+PROFILE_IDC_BASELINE);
        */
        /*
