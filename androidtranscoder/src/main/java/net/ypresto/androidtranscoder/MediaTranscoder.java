...
public class MediaTranscoder {
     ...
     */
    public void transcodeVideo(final File inPath, final String outPath, final MediaFormatStrategy outFormatStrategy, final Listener listener) throws IOException {
